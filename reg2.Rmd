...
```{r create label}
#label dilakukan menggunakan K-Means dengan jumlah cluster=5
...
```{r rename label}
#Ubah nama label menjadi string
...
```{r numerical columns}
num_columns <- c("hour", "atemp", "humidity", "windspeed")
```
